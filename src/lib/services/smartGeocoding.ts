...
export function extractAndNormalizeTDPName(address: string, tdpList: TDPItem[]): TDPItem | null {
  ...
  const namedAreaRules: { pattern: RegExp; searchNames: string[] }[] = [
    { pattern: /vân\s*dương\s*1|van\s*duong\s*1/i, searchNames: ["Vân Dương 1", "Tổ Dân Phố 26"] },
    { pattern: /vân\s*dương\s*2|van\s*duong\s*2/i, searchNames: ["Vân Dương 2", "Tổ Dân Phố 27"] },
    { pattern: /vân\s*dương|van\s*duong/i, searchNames: ["Vân Dương 1", "Tổ Dân Phố 26"] },
    { pattern: /quan\s*nam\s*1|quan\s*nam\s*1/i, searchNames: ["Quan Nam 1", "Tổ Dân Phố 19"] },
    { pattern: /quan\s*nam\s*2|quan\s*nam\s*2/i, searchNames: ["Quan Nam 2", "Tổ Dân Phố 20"] },
    { pattern: /quan\s*nam\s*3|quan\s*nam\s*3/i, searchNames: ["Quan Nam 3", "Tổ Dân Phố 22"] },
    { pattern: /quan\s*nam\s*4|quan\s*nam\s*4/i, searchNames: ["Quan Nam 4", "Tổ Dân Phố 23"] },
    { pattern: /quan\s*nam\s*5|quan\s*nam\s*5/i, searchNames: ["Quan Nam 5", "Tổ Dân Phố 21"] },
    { pattern: /quan\s*nam|quan\s*nam/i, searchNames: ["Quan Nam 1", "Tổ Dân Phố 19"] },
    { pattern: /hưởng\s*phước|huong\s*phuoc/i, searchNames: ["Hưởng Phước", "Tổ Dân Phố 24"] },
    { pattern: /tân\s*ninh|tan\s*ninh|hiền\s*tân|hiền\s*phước/i, searchNames: ["hiền Tân", "Tổ Dân Phố 25"] },
    { pattern: /quang\s*thành\s*9/i, searchNames: ["Quang Thành 9", "Tổ Dân Phố 1"] },
    { pattern: /quang\s*thành\s*8/i, searchNames: ["Quang Thành 8", "Tổ Dân Phố 2"] },
    { pattern: /quang\s*thành\s*7/i, searchNames: ["Quang Thành 7", "Tổ Dân Phố 3"] },
    { pattern: /quang\s*thành\s*6/i, searchNames: ["Quang Thành 6", "Tổ Dân Phố 4"] },
    { pattern: /quang\s*thành\s*5/i, searchNames: ["Quang Thành 5", "Tổ Dân Phố 5"] },
    { pattern: /quang\s*thành\s*1/i, searchNames: ["Quang Thành 1", "Tổ Dân Phố 7"] },
    { pattern: /quang\s*thành\s*2/i, searchNames: ["Quang Thành 2", "Tổ Dân Phố 9"] },
    { pattern: /quang\s*thành\s*3/i, searchNames: ["Quang Thành 3", "Tổ Dân Phố 10"] },
    { pattern: /quang\s*thành\s*4/i, searchNames: ["Quang Thành 4", "Tổ Dân Phố 11"] },
    { pattern: /quang\s*thành/i, searchNames: ["Quang Thành 1", "Tổ Dân Phố 7"] },
    { pattern: /đa\s*phước\s*1/i, searchNames: ["Đa Phước 1", "Tổ Dân Phố 13"] },
    { pattern: /đa\s*phước\s*2/i, searchNames: ["Đa Phước 2", "Tổ Dân Phố 8"] },
    { pattern: /đa\s*phước\s*3/i, searchNames: ["Đa Phước 3", "Tổ Dân Phố 6"] },
    { pattern: /đa\s*phước\s*4/i, searchNames: ["Đa Phước 4", "Tổ Dân Phố 12"] },
    { pattern: /thanh\s*vinh\s*1/i, searchNames: ["Thanh Vinh 1", "Tổ Dân Phố 15"] },
    { pattern: /thanh\s*vinh\s*2/i, searchNames: ["Thanh Vinh 2", "Tổ Dân Phố 16"] },
    { pattern: /thanh\s*vinh\s*3/i, searchNames: ["Thanh Vinh 3", "Tổ Dân Phố 14"] },
    { pattern: /nguyễn\s*lương\s*bằng|nguyen\s*luong\s*bang/i, searchNames: ["Tổ Dân Phố 4", "Tổ Dân Phố 5"] }
  ];
